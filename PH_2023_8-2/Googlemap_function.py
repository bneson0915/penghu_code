...
def googlemap_search(lat,lng):
    ...
    gmaps=googlemaps.Client(key="AIzaSyCa5Ww5XHTu4cJCSSfZaxf1GGUTHyyYIx0")
    ...
    with open('C:/Users/roy88/testproject/python/PH/hotel_data.csv','w+',newline='',encoding='utf-8-sig')as csvfile:
...
def googlemap_search_nearby(lat,lng,keyword):
    ...
    #config.read('information.ini')
    #gmaps=googlemaps.Client(key=config.get('googlemap','api_key'))
    api_key = "AIzaSyCa5Ww5XHTu4cJCSSfZaxf1GGUTHyyYIx0"
    gmaps=googlemaps.Client(key="AIzaSyCa5Ww5XHTu4cJCSSfZaxf1GGUTHyyYIx0")
    #change to dictionary
    loc={'lat':lat,'lng':lng}
    rad=1000
    ...
    with open('C:/Users/roy88/testproject/python/PH/recommend.csv','w+',newline='',encoding='utf-8-sig')as csvfile:
        writer=csv.writer(csvfile)
