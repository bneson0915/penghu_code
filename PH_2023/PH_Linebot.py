...
PHP_ngrok ="https://5e61-140-115-212-35.ngrok-free.app"
    ...
    try:
        ...
        if type=='text':
            ...
            if msg == "行程規劃":
                ...
                line_bot_api.reply_message(tk, [TextSendMessage("請點選以下網址，將由大數據為您分析這時間的人潮"),TextSendMessage(str(PHP_ngrok)+"/PengHu/PengHu_crowd.php")])
            else :
                print(msg)                                       # 印出內容
                reply = msg
