...
def filter(file,userID):
    ...
    with open(file, mode='r', newline='' , encoding='utf-8-sig') as rfile:
        ...
        with open('C:/Users/roy88/testproject/python/PH/plan.csv', mode='w', newline='' , encoding='utf-8-sig') as wfile:
            # 設置 CSV 寫入器
...
filter('C:/Users/roy88/testproject/python/PH/plan_2day.csv','U16f92b0df914c40495c60e84bf79adba')   